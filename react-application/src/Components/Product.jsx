            ...
            <>
             <div className="col-md-3">
                ...
                <div className="col-md-6" style={{lineHeight:2}}>
                    ...
                    <Skeleton height={25} width={100} style={{marginLeft:6}} />
                </div>
            </>
        )
    };
    const ShowProduct=() => {
        return (
          ...
          <div className="col-md-6">
            <img src={product.image} height="400px" width="400px"alt={product.title}/>
          </div>
          <div className="col-md-6">
          ...
          <NavLink to="/cart" className="btn btn-dark ms-2 px-3 py-2" data={product}>Go to Cart</NavLink>
          </div>
            </>
        )
    }
